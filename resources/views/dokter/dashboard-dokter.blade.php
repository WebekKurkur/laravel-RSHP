        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="get" action="{{ route('dokter.dashboard-dokter') }}" class="row g-2 align-items-center mb-3 justify-content-center">
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ route('dokter.dashboard-dokter') }}" class="btn btn-outline-secondary ms-2">Reset</a>
                        </div>
                    </form>
