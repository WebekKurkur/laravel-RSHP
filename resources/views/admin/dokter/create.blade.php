...
<div class="container">
    <div class="card mb-4">
        <div class="card-header"><div class="card-title">Tambah Dokter</div></div>
        <form action="{{ route('admin.dokter.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <label for="bidang_dokter" class="col-sm-2 col-form-label">Bidang</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('bidang_dokter') is-invalid @enderror" id="bidang_dokter" name="bidang_dokter" value="{{ old('bidang_dokter') }}">
